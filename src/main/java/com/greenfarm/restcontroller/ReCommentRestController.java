...
// public ResponseEntity<List<ReCommentDTO>> getListrecomment(){
// List<ReComment> recomments = recommentService.findAll();
// List<ReCommentDTO> reCommentDTOs = recomments.stream().map(recomment ->
// modelMapper.map(recomment, ReCommentDTO.class)).collect(Collectors.toList());
// return new ResponseEntity<>(reCommentDTOs, HttpStatus.OK);
//
// }
...
//// public ResponseEntity<CommentDTO> getOne(@PathVariable("commentid") Integer
// commentid) {
//// Comment Comment = commentService.findById(commentid);
////
//// if (Comment == null) {
...
//// public ResponseEntity<CommentDTO> update(@PathVariable("commentid") Integer
// commentid,
//// @RequestBody Comment comment) {
//// Comment updatedComment = commentService.update(comment);
////
//// if (updatedComment == null) {
//// // Trả về mã trạng thái 404 Not Found nếu không tìm thấy Comment để cập
// nhật
//// return ResponseEntity.notFound().build();
//// }
////
...
//// public ResponseEntity<Void> delete(@PathVariable("commentid") Integer
// commentid) {
