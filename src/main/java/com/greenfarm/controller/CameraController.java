...
public class CameraController {
    ...
    // // Logic để lấy danh sách camera, sử dụng WebRTC API hoặc một nguồn thông tin
    // khác
    ...
    // This endpoint captures an image from the webcam, decodes a QR code, and
    ...
    public ResponseEntity<String> captureAndScan(@RequestBody String imageDataUrl) {
        try {
            ...
            // ...
            // BufferedImage bufferedImage = webcam.getImage(); // Assuming selectedWebcam
            // is defined
